...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="content ">
      ...
      <div class="result">
        <div class="one_third first"><img src="images/planeta.jpg"></div>
        <div class="two_third">
          <p>Nombre: Planeta</p>
          <p>Dirección: Calle de Josefa Valcárcel, 42, 28027 Madrid</p>
          <p>Teléfono: 914 23 37 04</p>
        </div>
      </div>
      <!-- primer resultado de librerias -->
      <div class="result">
        <div class="one_third first "><img src="images/roca.jpg"></div>
        <div class="two_third">
          <p>Nombre: Roca</p>
          <p>Dirección: Avda. Marquès de l'Argentera 17, Principal 3ª - 08003 Barcelona</p>
          <p>Teléfono: 932 687 275</p>
        </div>
      </div>
    </div>
    <div class="clear"></div>
